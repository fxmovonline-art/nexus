  ...
  return (
    <DashboardLayout>
      <div className="text-center py-12">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">Find Investors</h1>
        <p className="text-gray-600">Browse and connect with potential investors for your startup</p>
